...
int BaseTextures::getGreyLevel()
{
    return this->greyLevel;
}

int BaseTextures::getNumDistances()
{
    return this->numDistances;
}

bool BaseTextures::isDistances(int index)
{
    return this->distances[index];
}

int BaseTextures::getNumDirections()
{
    return this->numDirections;
}

int BaseTextures::getNumDescriptors()
{
    return this->numDescriptors;
}

bool BaseTextures::isDescriptors(int index)
{
